...
s=s.replace('Streamer A is <b>${a} cm</b> long. Streamer B is <b>${extra} cm</b> longer than Streamer A.<br>(a) How long is Streamer B?<br>(b) What is the total length of both streamers?', 'A blue lane-marker strip is <b>${a} cm</b> long. A yellow lane-marker strip is <b>${extra} cm</b> longer than the blue strip.<br>(a) How long is the yellow strip?<br>(b) What is the total length of both marker strips?')
s=s.replace('Streamer A', 'Blue strip').replace('Streamer B', 'Yellow strip')
s=s.replace('The total length of both streamers is', 'The total length of both marker strips is')
s=s.replace('Streamer B = ${a} + ${extra} = ${b}. Then ${a} + ${b} = ${total}.', 'Yellow strip = ${a} + ${extra} = ${b} cm. Then ${a} + ${b} = ${total} cm altogether.')
